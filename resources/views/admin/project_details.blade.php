...
@section("title")
Users Project Detail Page | Rain Gutter Visualizer
@endsection
        ...
        <div class="tab-content">
         ...
         <div class="tab-pane active" id="save_project">
          <div class="login-form register-form">
            <!--Save Project Form-->
            <form  method="POST" action="{{route('admin_update_gallery_project')}}" id="project_create">
              @csrf
              <div class="form-group">
                ...
                <input type="hidden" name="user_id" id="user_id" value="{{$gallery->user_id}}">
